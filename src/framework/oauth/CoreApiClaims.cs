namespace Framework.OAuth
{
    ...
    public class CoreApiClaims
    {
         ...
         */
        public virtual void Load(ClaimsPrincipal principal)
        {
            // Read token values
        ...
        /*
         * Output claims to be included in the claims principal
         */
        public virtual void Output(IList<Claim> claimsList)
        {
            // Add token claims
